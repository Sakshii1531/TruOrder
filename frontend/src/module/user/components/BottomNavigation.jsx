  ...
  return (
    ...
    >
      <div className="flex items-center justify-around h-auto px-4 sm:px-6">
        ...
        >
          <Truck className={`h-5 w-5 ${isDelivery ? "text-sky-600 dark:text-sky-500 fill-sky-600 dark:fill-sky-500" : "text-gray-600 dark:text-gray-400"}`} strokeWidth={2} />
          <span className={`text-xs sm:text-sm font-medium ${isDelivery ? "text-sky-600 dark:text-sky-500 font-semibold" : "text-gray-600 dark:text-gray-400"}`}>
            Delivery
          </span>
          {isDelivery && (
            <div className="absolute top-0 left-0 right-0 h-0.5 bg-sky-600 dark:bg-sky-500 rounded-b-full" />
          )}
        </Link>
        ...
        >
          <Tag className={`h-5 w-5 ${isUnder250 ? "text-sky-600 dark:text-sky-500 fill-sky-600 dark:fill-sky-500" : "text-gray-600 dark:text-gray-400"}`} strokeWidth={2} />
          <span className={`text-xs sm:text-sm font-medium ${isUnder250 ? "text-sky-600 dark:text-sky-500 font-semibold" : "text-gray-600 dark:text-gray-400"}`}>
            Under 250
          </span>
          {isUnder250 && (
            <div className="absolute top-0 left-0 right-0 h-0.5 bg-sky-600 dark:bg-sky-500 rounded-b-full" />
        ...
        >
          <UtensilsCrossed className={`h-5 w-5 ${isDining ? "text-sky-600 dark:text-sky-500 fill-sky-600 dark:fill-sky-500" : "text-gray-600 dark:text-gray-400"}`} strokeWidth={2} />
          <span className={`text-xs sm:text-sm font-medium ${isDining ? "text-sky-600 dark:text-sky-500 font-semibold" : "text-gray-600 dark:text-gray-400"}`}>
            Dining
          </span>
          {isDining && (
            <div className="absolute top-0 left-0 right-0 h-0.5 bg-sky-600 dark:bg-sky-500 rounded-b-full" />
        ...
        >
          <User className={`h-5 w-5 ${isProfile ? "text-sky-600 dark:text-sky-500 fill-sky-600 dark:fill-sky-500" : "text-gray-600 dark:text-gray-400"}`} />
          <span className={`text-xs sm:text-sm font-medium ${isProfile ? "text-sky-600 dark:text-sky-500 font-semibold" : "text-gray-600 dark:text-gray-400"}`}>
            Profile
          </span>
          {isProfile && (
            <div className="absolute top-0 left-0 right-0 h-0.5 bg-sky-600 dark:bg-sky-500 rounded-b-full" />
