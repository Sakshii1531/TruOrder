...
export default function PageNavbar({
  ...
  const mainLocationName = locationDisplay.main === "Unknown City" ? "Select location" : locationDisplay.main
  const subLocationName = locationDisplay.sub === "Unknown City" ? "" : locationDisplay.sub
      ...
      <div className="flex items-center justify-between gap-2 sm:gap-3 md:gap-4 lg:gap-6 max-w-7xl mx-auto">
        ...
        <div className="flex-1 flex items-center justify-center min-w-0 px-2">
          <Button
            ...
            disabled={loading}
            className="h-auto px-0 py-0 hover:bg-transparent transition-colors max-w-full"
          >
            {loading ? (
              ...
              <div className="flex flex-col items-center min-w-0">
                <div className="flex items-center gap-1">
                  <FaLocationDot className={`h-3 w-3 sm:h-3.5 sm:w-3.5 text-sky-500`} />
                  <span className={`text-sm sm:text-base font-bold ${textColorClass} truncate max-w-[120px] sm:max-w-[150px]`}>
                    {mainLocationName}
                  </span>
