...
export default function HomePage() {
  ...
  const categories = [
    ...
    { id: 2, name: "Bengali", image: "https://images.unsplash.com/photo-1551024506-0bccd828d307?w=200&h=200&fit=crop", color: "bg-sky-100" },
    ...
    { id: 5, name: "Italian", image: "https://images.unsplash.com/photo-1551183053-bf91a1d81141?w=200&h=200&fit=crop", color: "bg-sky-100" },
  ...
  return (
    <div className="min-h-screen bg-[#f6e9dc] overflow-x-hidden pb-20">
      ...
      <div className="bg-[#38BDF8] w-full px-4 py-3 relative rounded-b-3xl">
            ...
            <img 
              ...
              <div className="absolute inset-0 flex items-center px-4 py-3">
                <div className="flex-1 z-10">
                  ...
                  >
                    <Button 
                      className="bg-transparent border-2 border-[#38BDF8] text-white hover:bg-[#38BDF8] rounded-full px-3 md:px-5 py-1.5 md:py-2 text-xs md:text-sm font-semibold transition-colors"
                    >
                      Order Now
                    </Button>
              ...
              <motion.div 
                ...
                className="absolute bottom-2 md:bottom-4 right-2 md:right-4 bg-[#38BDF8] text-white rounded-full px-2 md:px-3 py-1 md:py-1.5 text-[10px] md:text-xs font-bold shadow-lg"
              >
            ...
            <button
              ...
              onClick={() => setCurrentSlide(index)}
                className={`h-1.5 md:h-2 rounded-full transition-all duration-300 ${
                  index === currentSlide ? 'bg-[#38BDF8] w-5 md:w-6' : 'bg-white/50 w-1.5 md:w-2 hover:bg-white/70'
                }`}
            />
          ))}
          </div>
      ...
      <div className="px-4 mb-6 -mt-2">
        <div className="flex items-center justify-between mb-3">
          ...
          <button 
            ...
            className="bg-[#38BDF8] rounded-full p-1.5 hover:bg-[#0284C7] transition-colors"
          >
      ...
      <div className="px-4 mb-6">
        <h3 className="text-lg font-bold text-[#38BDF8] mb-1">Today's Trends</h3>
          ...
          {trendsItems.map((item) => (
            ...
            >
              ...
              <div className="p-2.5 flex flex-col flex-1">
                ...
                {/* Add Button */}
                <Button 
                  className="w-full bg-[#38BDF8] hover:bg-[#0284C7] text-white text-xs font-semibold py-1.5 rounded-lg"
                  onClick={(e) => {
                    e.stopPropagation()
      ...
      <div className="px-4 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="w-8 h-8 rounded-full border-2 border-[#38BDF8] flex items-center justify-center hover:bg-[#38BDF8]/10 transition-colors">
          ...
          {popularRestaurants.map((restaurant) => (
            ...
            >
              ...
              <div className="relative w-full h-40 rounded-t-xl overflow-hidden">
                ...
                <div className="absolute bottom-2 right-2 bg-white border-2 border-[#38BDF8] rounded-lg px-2.5 py-1 shadow-md">
              ...
              <div className="p-3 pt-2 relative">
                ...
                <div className="absolute -top-5 left-3 w-10 h-10 bg-white border border-gray-300 rounded-lg flex items-center justify-center flex-shrink-0 shadow-md z-10">
                  {restaurant.restaurantIcon && (
                    <restaurant.restaurantIcon className="w-5 h-5 text-[#38BDF8]" />
                  )}
                </div>
                ...
                <div className="flex items-center gap-3 mt-2 pt-2 border-t border-gray-100">
                  <div className="flex items-center gap-1">
                    <Star className="w-3.5 h-3.5 text-[#38BDF8] fill-[#38BDF8]" />
          ...
          <div className="flex items-center gap-3 md:gap-6 p-4 md:p-8 h-full">
            ...
            <div className="flex items-center justify-center flex-shrink-0 w-24 h-24 md:w-40 md:h-40 relative">
              ...
              <div className="absolute top-1 left-1/2 -translate-x-1/2 w-16 h-16 md:w-28 md:h-28 z-10">
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute inset-0 rounded-t-full overflow-hidden">
                    <div className="w-full h-full bg-[#38BDF8]"></div>
              ...
              <div className="absolute bottom-6 md:bottom-12 left-1/2 -translate-x-1/2 w-14 h-14 md:w-24 md:h-24 bg-white rounded-full shadow-lg flex items-center justify-center z-20">
                ...
                <div className="relative">
                  <div className="w-7 h-7 md:w-12 md:h-12 bg-sky-500 rounded-full flex items-center justify-center">
              ...
              <div className="absolute bottom-3 md:bottom-8 left-3 md:left-8 w-6 h-6 md:w-10 md:h-10 z-10">
                <div className="w-full h-full relative">
                  ...
                  {/* Chair seat */}
                  <div className="absolute bottom-0 left-0 right-0 h-2.5 md:h-4 bg-[#38BDF8] rounded-b-lg"></div>
                </div>
              </div>
            ...
            <div className="flex flex-col items-center gap-2 md:gap-3 flex-shrink-0">
              ...
              <Button
                ...
                className="bg-[#38BDF8] hover:bg-[#0284C7] text-white font-semibold px-4 py-2 md:px-8 md:py-3 rounded-lg text-sm md:text-base shadow-md transition-all hover:scale-105 whitespace-nowrap"
              >
                See Location
              </Button>
            </div>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50">
        <div className="flex items-center justify-around py-2 px-4">
          <button className="flex flex-col items-center gap-1 p-2 text-[#38BDF8]">
            <Home className="w-6 h-6" />
            <span className="text-xs text-[#38BDF8] font-medium">Home</span>
          </button>
          <button 
            onClick={() => navigate('/usermain/wishlist')}
            className="flex flex-col items-center gap-1 p-2 text-gray-600 hover:text-[#38BDF8] transition-colors"
          >
